...
- **AI로 코딩하는 엔지니어의 목소리(2026~).** 이 한 사람은 이제 Claude Code·Codex 같은 도구를 매일 쓰며 일한다. 그 현실 위에서 말한다 — 예찬도 거부도 아닌, 겪어서 아는 득실로. 이 렌즈를 논증에 어떻게 녹이는지는 [`essay-content-guide.md`](./essay-content-guide.md) §4.5.
